...
-- Add triggers to automatically log critical data access
...
AS $$
BEGIN
  -- Log when financial data is accessed
  PERFORM public.log_security_event(
    ...
    10 -- Medium risk score for financial access
  );
...
BEGIN
  ...
  PERFORM public.log_security_event(
    ...
    CASE WHEN OLD.role != NEW.role THEN 50 ELSE 5 END -- Higher risk for role changes
  );
